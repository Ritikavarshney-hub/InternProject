...
print("IMG_CONTEXT ID:", model.img_context_token_id)
...
for i, row in enumerate(sample):
    ...
    with torch.no_grad():
       out = model.generate( pixel_values=pixel_values, input_ids=input_ids, **GENERATION_CONFIG, )
